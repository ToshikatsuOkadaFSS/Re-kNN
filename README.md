...
* **Corpus Domain**: 300 dimensions (Target: word vectors such as fastText)
...
A Python package and a sample application for creating a text index have been added.
This is provided as a template for evaluation programs using Python.

For more details, please refer to the following:  

- [LICENSE](./LICENSE)
- [Python_SAMPLE_APP](./docs/Python_SAMPLE_APP.md)
