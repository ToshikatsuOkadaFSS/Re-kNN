...
namespace RekNNCIFAR10
{
    ...
    public class Settings :FSCLJsonSerializeBase
    {
        ...
        public List<string> TrainFilePaths { get; set; } = new() { "your\\data_batch_1.bin", "your\\data_batch_2.bin", "your\\data_batch_3.bin", "your\\data_batch_4.bin", "your\\data_batch_5.bin" };

        public string TestFilePath { get; set; } = "your\\test_batch.bin";
